...
const translations = {
  cs: {
    ...
    langBtn: 'Jazyk ▼',
    heroTitle: 'Bezpečně a připraveni na cestu.',
    heroDesc: 'V Mechanik-Plus přistupujeme ke každému vozidlu jako k vlastnímu — nabízíme poctivé, kvalitní opravy a servis, který vás udrží v pohybu.',
    heroBtn: 'Objednat servis',
    servicesTitle: 'Naše základní služby',
    service1Title: 'Preventivní údržba',
    service1Desc: 'Výměna oleje a filtrů, kontrola kapalin, rotace pneumatik a sezónní prohlídky — malé práce, které zabrání velkým opravám.',
    service2Title: 'Diagnostika a opravy',
    service2Desc: 'Přesná diagnostika závad motorů, brzd, podvozku nebo převodovky — opraveno správně napoprvé.',
    service3Title: 'Pneumatiky a geometrie',
    service3Desc: 'Nové pneumatiky, vyvážení a čtyřkolová geometrie pro lepší spotřebu a bezpečnost.',
    service4Title: 'Speciální služby',
    service4Desc: 'Oprava klimatizace, diagnostika elektroinstalace, výfukové práce a výkonové ladění — každé auto si zaslouží odbornou péči.',
    quoteText1: '"Od kontrolky motoru po výměnu brzd"',
    quoteText2: '— postaráme se o vás."',
    quoteCaption: 'Od preventivní údržby po komplexní diagnostiku, postaráme se o vás.',
    bookingTitle: 'Objednejte svůj servis',
    bookingDesc1: 'Řekněte nám, co potřebujete, a my potvrdíme termín schůzky hned.',
    bookingDesc2: 'Příjem bez objednávky vítán, ale objednávka předem znamená rychlejší servis.',
    contactNameLabel: 'Jméno',
    contactEmailLabel: 'E-mailová adresa',
    contactMessageLabel: 'Napište zprávu',
    contactBtn: 'Odeslat',
    ...
    footerAddress: 'Líšný 2.díl 6, 468 22 Líšný-Železný Brod, Czech',
    footerMap: 'https://www.google.com/maps?q=Líšný+2.díl+6,+468+22+Líšný-Železný+Brod,+Česko&output=embed',
    footerHoursTitle: 'Godziny pracy:',
    footerHoursMonFri: 'Pn-Pt: 08:00-20:00',
    footerHoursSat: 'Sb: 09:00-14:00',
    footerHoursSun: 'Nd: Po ustaleniu',
  ...
  uk: {
    ...
    langBtn: 'Мова ▼',
    heroTitle: 'Безпечно та готові до дороги.',
    heroDesc: 'У Mechanik-Plus ми ставимося до кожного автомобіля як до свого — пропонуємо чесний, якісний ремонт і обслуговування, щоб ви завжди були в русі.',
    heroBtn: 'Записатися на сервіс',
    servicesTitle: 'Наші основні послуги',
    service1Title: 'Профілактичне обслуговування',
    service1Desc: 'Заміна оливи та фільтрів, перевірка рідин, ротація шин та сезонні огляди — дрібні роботи, що запобігають великому ремонту.',
    service2Title: 'Діагностика та ремонт',
    service2Desc: 'Точне виявлення несправностей двигунів, гальм, підвіски чи трансмісії — виправлено правильно з першого разу.',
    service3Title: 'Шини та вирівнювання',
    service3Desc: 'Нові шини, балансування та чотириколісне вирівнювання для кращої економії палива і безпеки.',
    service4Title: 'Спеціальні послуги',
    service4Desc: 'Ремонт кондиціонера, діагностика електрики, роботи з вихлопною системою та тюнінг — кожне авто заслуговує на фахову увагу.',
    quoteText1: '"Від лампочки двигуна до заміни гальм"',
    quoteText2: '— ми подбаємо про вас."',
    quoteCaption: 'Від профілактичного обслуговування до складної діагностики, ми подбаємо про вас.',
    bookingTitle: 'Запишіться на сервіс',
    bookingDesc1: 'Розкажіть нам, що вам потрібно, і ми підтвердимо час прийому одразу.',
    bookingDesc2: 'Приймаємо без запису, але завчасна запис означає швидший сервіс.',
  ...
  en: {
    ...
    service1Title: 'Preventive Maintenance',
    service1Desc: 'Oil & filter changes, fluid checks, tire rotation, and seasonal inspections — small jobs that prevent big repairs.',
    service2Title: 'Diagnostics & Repairs',
    service2Desc: 'Accurate troubleshooting for engines, brakes, suspension, or transmission issues — fixed right the first time.',
    service3Title: 'Tires & Alignment',
    service3Desc: 'New tires, balancing, and four-wheel alignment for better mileage and safety.',
    service4Title: 'Specialty Services',
    service4Desc: 'AC repair, electrical diagnostics, exhaust work, and performance tuning — because every car deserves expert attention.',
