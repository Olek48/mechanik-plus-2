...
const translations = {
  cs: {
    ...
    service1Desc: 'Pomocí moderních diagnostických přístrojů rychle odhalíme závady ve všech systémech vašeho vozidla — motor, převodovka, elektrika i podvozek.',
    service2Title: 'Výměna oleje',
    service2Desc: 'Provádíme rychlou výměnu motorového oleje a filtrů pro všechny typy vozidel. Používáme pouze kvalitní oleje doporučené výrobcem.',
    service3Title: 'Servis brzd',
    service3Desc: 'Kontrola, seřízení a výměna brzdových destiček, kotoučů a brzdových čelistí. Vaše bezpečnost je naší prioritou.',
    service4Title: 'Pneuservis',
    service4Desc: 'Přezutí, vyvážení a sezónní výměna pneumatik pro osobní i dodávkové vozy. Skladujeme vaše pneumatiky po celou sezónu.',
    ...
    service5Desc: 'Opravy tlumičů, pružin, ramen, čepů a celého podvozkového systému včetně vzduchového podvozku jakékoli složitosti.',
    service6Title: 'Diagnostika a oprava palivového systému',
    service6Desc: 'Diagnostika a oprava vstřikovačů, palivových pump, filtrů a celého palivového systému benzínových i dieselových motorů.',
    service7Title: 'Oprava motoru, převodovky, spojky',
    service7Desc: 'Profesionální oprava a repase motorů, převodovek a spojek všech značek. Pracujeme precizně a používáme kvalitní náhradní díly.',
    service8Title: 'Autoelektrikář',
    service8Desc: 'Diagnostika a oprava elektrických systémů, palubní elektroniky, světel, startérů, alternátorů a dalších elektrických komponentů.',
    service9Title: 'Montáž doplňkového vybavení',
    service9Desc: 'Montáž tažných zařízení, střešních nosičů, kamer, parkovacích senzorů a dalšího příslušenství pro váš vůz.',
    service10Title: 'Leštění světlometů',
    service10Desc: 'Profesionální renovace světlometů obnoví jejich průhlednost a výrazně zlepší viditelnost při nočním řízení.',
    service11Title: 'Antikorozní úprava',
    service11Desc: 'Ochrana karoserie a podvozku proti korozi speciálními přípravky. Prodloužíme životnost vašeho vozidla a ochráníme ho před rzí.',
    service12Title: 'Výměna prahů',
    service12Desc: 'Kvalitní výměna a oprava prahů automobilu. Používáme originální nebo kvalitní náhradní díly pro dlouhou životnost opravy.',
  ...
  uk: {
    ...
    service1Desc: 'За допомогою сучасних діагностичних приладів швидко виявимо несправності в усіх системах вашого авто — двигун, коробка передач, електрика та підвіска.',
    service2Title: 'Заміна оливи',
    service2Desc: 'Виконуємо швидку заміну моторної оливи та фільтрів для всіх типів автомобілів. Використовуємо лише якісні оливи, рекомендовані виробником.',
    service3Title: 'Сервіс гальм',
    service3Desc: 'Перевірка, регулювання та заміна гальмівних колодок, дисків і барабанів. Ваша безпека — наш пріоритет.',
    service4Title: 'Шиномонтаж',
    service4Desc: 'Монтаж, балансування та сезонна заміна шин для легкових і вантажних авто. Зберігаємо ваші шини протягом усього сезону.',
    ...
    service5Desc: 'Ремонт амортизаторів, пружин, важелів, кульових опор та всієї підвіски, включаючи пневматичну, будь-якої складності.',
    service6Title: 'Діагностика і ремонт паливної системи',
    service6Desc: 'Діагностика та ремонт форсунок, паливних насосів, фільтрів і всієї паливної системи бензинових і дизельних двигунів.',
    service7Title: 'Ремонт двигуна, коробки передач, зчеплення',
    service7Desc: 'Професійний ремонт і відновлення двигунів, коробок передач та зчеплень усіх марок. Працюємо точно і використовуємо якісні запчастини.',
    service8Title: 'Автоелектрик',
    service8Desc: 'Діагностика та ремонт електричних систем, бортової електроніки, фар, стартерів, генераторів та інших електричних компонентів.',
    service9Title: 'Встановлення додаткового обладнання',
    service9Desc: 'Монтаж фаркопів, дахових багажників, камер, парктроніків та іншого додаткового обладнання для вашого автомобіля.',
    service10Title: 'Полірування фар',
    service10Desc: 'Професійне відновлення фар поверне їм прозорість і значно покращить видимість під час нічного водіння.',
    service11Title: 'Антикорозійна обробка',
    service11Desc: 'Захист кузова та підвіски від корозії спеціальними засобами. Подовжимо термін служби вашого авто і захистимо його від іржі.',
    service12Title: 'Заміна порогів',
    service12Desc: 'Якісна заміна та ремонт порогів автомобіля. Використовуємо оригінальні або якісні замінники для тривалого результату.',
  ...
  en: {
    ...
    service1Desc: 'Using modern diagnostic equipment we quickly identify faults in all vehicle systems — engine, gearbox, electrics and suspension.',
    service2Title: 'Oil Change',
    service2Desc: 'We perform fast oil and filter changes for all vehicle types using only manufacturer-recommended quality oils.',
    service3Title: 'Brake Service',
    service3Desc: 'Inspection, adjustment and replacement of brake pads, discs and drums. Your safety is our top priority.',
    service4Title: 'Tire Service',
    service4Desc: 'Mounting, balancing and seasonal tire changes for passenger and commercial vehicles. We store your tires throughout the season.',
    ...
    service5Desc: 'Repair of shock absorbers, springs, arms, ball joints and the entire suspension system including air suspension of any complexity.',
    service6Title: 'Fuel System Diagnostics and Repair',
    service6Desc: 'Diagnostics and repair of injectors, fuel pumps, filters and the entire fuel system for petrol and diesel engines.',
    service7Title: 'Engine, Gearbox, and Clutch Repair',
    service7Desc: 'Professional repair and overhaul of engines, gearboxes and clutches of all brands. We work precisely using quality spare parts.',
    service8Title: 'Auto Electrician',
    service8Desc: 'Diagnostics and repair of electrical systems, onboard electronics, lights, starters, alternators and other electrical components.',
    service9Title: 'Additional Equipment Installation',
    service9Desc: 'Installation of tow bars, roof racks, cameras, parking sensors and other accessories for your vehicle.',
    service10Title: 'Headlight Polishing',
    service10Desc: 'Professional headlight restoration restores clarity and significantly improves visibility during night driving.',
    service11Title: 'Anti-corrosion Treatment',
    service11Desc: 'Protection of the body and chassis against corrosion using specialist products. We extend the life of your vehicle and protect it from rust.',
    service12Title: 'Sill Replacement',
    service12Desc: 'Quality replacement and repair of car sills using original or high-quality aftermarket parts for long-lasting results.',
